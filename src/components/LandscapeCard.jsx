...
const LandscapeCard = (props) => {
  ...
  return (
    <>
      <div
        className="LandscapeCard flex "
        // style={{
        //   width: `296px`,
        // }}
      >
        <div
          className="pic flex flex-di-rr"
          style={{
            background: `url('${props.obj.video.thumbnails[indx].url}') center center no-repeat`,
            // height: `166px`,
        ...
        <div className="box flex flex-ai-c flex-di-co flex-jc-sb">
          ...
          <div className="channel">
            <span> {props.obj.video.channelName}</span>
            {props.obj.video.viewCountText}
          </div>
          <div className="btn flex flex-di-rr">
            ...
            >
              <div
                className="downlod flex flex-ai-c"
                onClick={() => {
                  getLinks();
            ...
            <div
              className={
                linksActive
                  ? "links position-st flex flex-di-co flex-ai-c flex-jc-c"
                  : "display-none"
              }
            >
